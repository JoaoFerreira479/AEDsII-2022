...
public class AnalisadorCodigoAprimorado {
	...
	public static void main(String[] args) {
		...
		String codigoEntrada = codigo.toString().trim();
	...
	private static void analisarLoopSimples(String codigo) {
		...
		if (matcher.find()) {
			...
			calcularSomatorio(expressao, cabecalho);
		}
	}
	...
	private static String extrairOperacao(String codigo) {
		...
		if (operacaoMatcher.find()) {
			return operacaoMatcher.group(0).trim();
		}
		return "";
	}

	private static void calcularSomatorio(String expressao, String cabecalho) {
